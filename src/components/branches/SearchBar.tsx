  ...
  return (
    <div className="relative z-20 mx-auto -mt-8 w-full max-w-[700px] px-4">
      ...
      >
        ...
        />
        <button
          className="ml-2 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cream transition-colors duration-300 hover:bg-gold hover:text-midnight"
